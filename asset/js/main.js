...
(function ($) {
    ...
    var stickyTabs = function () {
        // El right-nav tiene su propio controlador de scroll (definido en
        // index.html) porque incluye la sección de Works, que se pinea con
        // GSAP y rompe el cálculo de offset() que usa esta función.
        let sectionIds = $('a.scroll-to').not('.right-nav a');
